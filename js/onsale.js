...
function filterTag(getTag){
    ...
    lte = "2100-05-30T00:00:00Z";
						...
						else if (tags === "cen_time")  {
	document.getElementById("descTurco").innerHTML = "Out of ideas or wanna nurture your creative thinking with challenges? Welcome to our '1topic 1week' challenge, challengetnunc!<br>Here is the seventh topic to keep you busy! <b>*time*</b> <br>Swap by <b>22.10.2021 Friday</b> together with the hashtags <b>#challengetnunc #cen_time</b> <br>No winners. Meet new artists and have fun.";
	gte = "2020-05-20T00:00:00Z";
    lte = "2100-05-30T00:00:00Z";
	}
							else if (tags === "cen_halloween")  {
	document.getElementById("descTurco").innerHTML = "Out of ideas or wanna nurture your creative thinking with challenges? Welcome to our '1topic 1week' challenge, challengetnunc!<br>Here is the eighth topic to keep you busy! <b>*halloween*</b> <br>Swap by <b>29.10.2021 Friday</b> together with the hashtags <b>#challengetnunc #cen_halloween</b> <br>No winners. Meet new artists and have fun.";
	gte = "2020-05-20T00:00:00Z";
    lte = "2100-05-30T00:00:00Z";
	}
